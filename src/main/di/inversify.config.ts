import { Clipboard, Dialog, IpcMain, Protocol, clipboard, dialog, ipcMain, protocol } from "electron";
...
diContainer.bind<ElectronStore>(TYPES.ElectronStore).toConstantValue(new ElectronStore());
...
diContainer.bind(TYPES.RepoFactory)
